...
def list_view(request):
    ...
    return render(request, 'house/message/list.html', template_data)
...
def new_view(request):
    ...
    return render(request, 'house/message/new.html', template_data)
...
def read_message(request, pk):
    ...
    return render(request, 'message/read_message.html', context)